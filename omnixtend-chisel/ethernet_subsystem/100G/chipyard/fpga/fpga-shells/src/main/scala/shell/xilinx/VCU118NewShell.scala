  ...
  extends EthernetUltraScalePlacedOverlay(name, designInput, shellInput, XXVEthernetParams(name = name, speed   = 10, dclkMHz = 125))
{
  ...
  shell { InModuleBody {
    ...
    shell.xdc.addPackagePin(io.tx0_p, "V7")
    shell.xdc.addPackagePin(io.tx0_n, "V6")
    shell.xdc.addPackagePin(io.tx1_p, "T7")
    shell.xdc.addPackagePin(io.tx1_n, "T6")
    shell.xdc.addPackagePin(io.tx2_p, "P7")
    shell.xdc.addPackagePin(io.tx2_n, "P6")
    shell.xdc.addPackagePin(io.tx3_p, "M7")
    shell.xdc.addPackagePin(io.tx3_n, "M6")
    shell.xdc.addPackagePin(io.rx0_p, "Y2")
    shell.xdc.addPackagePin(io.rx0_n, "Y1")
    shell.xdc.addPackagePin(io.rx1_p, "W4")
    shell.xdc.addPackagePin(io.rx1_n, "W3")
    shell.xdc.addPackagePin(io.rx2_p, "V2")
    shell.xdc.addPackagePin(io.rx2_n, "V1")
    shell.xdc.addPackagePin(io.rx3_p, "U4")
    shell.xdc.addPackagePin(io.rx3_n, "U3")
    shell.xdc.addPackagePin(io.refclk_p, "W9")
    shell.xdc.addPackagePin(io.refclk_n, "W8")
    shell.xdc.addPackagePin(io.gpio_sw_s, "BE22")
    shell.xdc.addIOStandard(io.gpio_sw_s, "LVCMOS18")
    shell.xdc.addPackagePin(io.gpio_sw_n, "BB24")
    shell.xdc.addIOStandard(io.gpio_sw_n, "LVCMOS18")
    shell.xdc.addPackagePin(io.gpio_sw_w, "BF22")
    shell.xdc.addIOStandard(io.gpio_sw_w, "LVCMOS18")
    shell.xdc.addPackagePin(io.gpio_sw_e, "BE23")
    shell.xdc.addIOStandard(io.gpio_sw_e, "LVCMOS18")
  } }
}
