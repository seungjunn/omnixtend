...
class AXI4StreamFIFO() extends BlackBox
{
...
class XXVEthernet(config: XXVEthernetParams)(implicit p: Parameters) extends LazyModule {
  ...
  lazy val module = new LazyModuleImp(this) {
    ...
    // ox2ethfifo.io.s_axis_tkeep := 255.U
